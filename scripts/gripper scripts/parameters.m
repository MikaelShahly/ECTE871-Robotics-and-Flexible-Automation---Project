...
robot.name= 'PARALLEL GRIPPER 0';

robot.DH.theta= '[pi/2 0]';
robot.DH.d='[0.1 0]';
%robot.DH.a='[-0.03*robot.tool_activated-0.03 0.06*robot.tool_activated+0.06]';
robot.DH.a='[-q(1)*0.04-0.005 q(2)*0.08+0.005]';
